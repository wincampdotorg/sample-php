...
set_time_limit(0);  
error_reporting(0);
ini_set('user_agent', 'Nonton Anime v6.6 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.125 Safari/537.36');
...
$video_url = $obj['streams'][0]['play_url'];// $video_url_hd = $obj['streams'][1]['play_url'];
